locals {
    ...
    subnet = {
        ...
        "workato-demo-shared-services": "subnet-0fdb86dba280ab175,subnet-0d75339567aca60a1,subnet-0a692e79a3324c8b8",
        "accelerators": "subnet-01b4da36447d5aaa1,subnet-0cdc041c04e8bfc1c"
    }    
}
